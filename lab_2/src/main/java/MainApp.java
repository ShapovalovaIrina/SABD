...
public class MainApp {
    ...
    public static void main(String[] args) throws Exception {
        ...
        InputStream publicCertificateStream = MainApp.class.getClassLoader().getResourceAsStream("public.cer");
        X509Certificate certificate = (X509Certificate) certFactory
                .generateCertificate(publicCertificateStream);

        char[] keystorePassword = "password".toCharArray();
        char[] keyPassword = "password".toCharArray();

        KeyStore keystore = KeyStore.getInstance("PKCS12");
        InputStream privateKeyStream = MainApp.class.getClassLoader().getResourceAsStream("private.p12");
        keystore.load(privateKeyStream, keystorePassword);
        ...
        System.out.println("Verifying was successful: " + check);
    }
}
